...
* Go to GitHub, click `ESE5023_Assignments_XXX` repository, then `Settings`. Under the `Manage access` sub-page, click `Invite a collaborator`, add invite `LIXicheng00`, and `chen-yuy` as collaborators. By doing so, your TAs will be able to get access to your GitHub `ESE5023_Assignments_XXX` repository, and they will grade your assignments and provide necessary feedback in the future. 
