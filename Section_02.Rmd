...
* Push it to GitHub as a `remote` repository. This is the place you are going to turn in your assignments, *e.g*., `PS1_1.py`, `PS1_2.py`, `PS3_3.py`,...

* Go to GitHub, click `ESE5023_Assignments_XXX` repository, then `Settings`. Under the `Manage access` sub-page, click `Invite a collaborator`, add invite `Wenfu-Sun`, `HowHuang`, and `juanli1007` as collaborators. By doing so, your TAs will be able to get access to your GitHub `ESE5023_Assignments_XXX` repository, and they will grade your assignments and provide necessary feedback in the future. 
