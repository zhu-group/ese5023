...
* Go to GitHub, click `ESE5023_Assignments_XXX` repository, then `Settings`. Under the `Collaborators` sub-page, then in `Manage access` box, click `Add people`, add invite `1637536121@qq.com`, `12332275@mail.sustech.edu.cn` and then `2217570376@qq.com` as collaborators. By doing so, your TAs will be able to get access to your GitHub `ESE5023_Assignments_XXX` repository, and they will grade your assignments and provide necessary feedback in the future. 
