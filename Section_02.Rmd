...
* Go to GitHub, click `ESE5023_Assignments_XXX` repository, then `Settings`. Under the `Collaborators` sub-page, then in `Manage access` box, click `Add people`, add invite `Winifred77836`, `12432908` and then `Wangxc5023` as collaborators. By doing so, your TAs will be able to get access to your GitHub `ESE5023_Assignments_XXX` repository, and they will grade your assignments and provide necessary feedback in the future. 
