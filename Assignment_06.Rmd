...
Upload your **Fortran programs** and **report** to the `ESE5023_Assignments` repository before the deadline.
...
**2.1 [5 points]** Write a module `Declination_angle` to calculate the *declination angle* in a certain date. 
...
**2.3 [5 points]** Create a library (`libsolar.a`) that contains `Declination_angle.o` and `AST.o`. Compile `Cal_SZA.f90` using `libsolar.a`.

**2.4 [5 points]** Print the SZA for Shenzhen (`22.542883N, 114.062996E`) at `14:35` (local time) on `2020-12-20`.
