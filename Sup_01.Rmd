---
title: "Intermediate `Python`: `xarray`"
output:
  html_document:
    toc: true
    toc_float:
...
```{python, eval=F}
# Take sqaure of the data (even though this makes no sense)
ds.tas ** 2
```
...
+ [Pythia Cookbooks Gallery](https://cookbooks.projectpythia.org/) (very comprehensive, contains many courses and tutorials)
