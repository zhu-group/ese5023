...
+ Download the [chromedriver file](https://chromedriver.chromium.org/downloads), unzip it, and **move the folder to your working directory**. You may need to use different versions depending on the version of your Google Chrome.
...
Activate the [`cper` environment](https://zhu-group.github.io/ese5023/Section_10.html#Using_a_Python_environment), as we will install `requests`, `BeautifulSoup`, and `Selenium` under it. 

```{bash, eval=F}
conda activate cper
```

If you fail to find `cper`, follow [Creating a `Python` environment](https://zhu-group.github.io/ese5023/Section_10.html#Creating_a_Python_environment) to create one.
...
Download the [chromedriver_win32.zip file](https://chromedriver.chromium.org/downloads) (if you use Windows), unzip it, and **move the folder to your working directory**. You should have a single executable file called `chromedriver.exe` in a folder called `chromedriver_win32` (if you use Windows). 
