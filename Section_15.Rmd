---
title: "Section 15 Web scraping with `Python`"
output:
  html_document:
    toc: true
    toc_float:
...
+ Download the [chromedriver file](https://chromedriver.chromium.org/downloads), unzip it, and **move the folder to your working directory**. You need to use same version of Google Chrome, if you have installed it already.
