...
If you’re having trouble using a function, 9 times out of 10, the answers you are seeking have **already been answered** on [Stack Overflow](https://stackoverflow.com/). You can search using the `[python-3.x]` tag. You will always find Google is your good friend.
