...
As we are using `Python` from `Anaconda`, official module files are located at: `C:\Users\xxx\anaconda3\Lib`, where `xxx` is your user name. Or `C:\ProgramData\anaconda3\Lib` depending on your system.  
...
* The new package will be installed at `C:\Users\xxx\anaconda3\Lib\site-packages\`, where `xxx` is your user name. Or `C:\ProgramData\anaconda3\Lib\site-packages\` depending on your system.  
