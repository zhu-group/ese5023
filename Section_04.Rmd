...
```{python, eval=F}
# Create a set
Air_pollutants = {"PM10", "PM2.5", "O3", "CO", "SO2", "NO2"}
...
Air_pollutants.update(New_pollutants)
print(Air_pollutants)

# Remove an item using remove
Air_pollutants.remove("PAH")
print(Air_pollutants)

# Remove an item using discard
Air_pollutants.discard("VOCs")
print(Air_pollutants)
```
...
## Exercise #3 Building a guessing game
