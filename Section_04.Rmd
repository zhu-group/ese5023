...
For now, we only cover the basic usage of Git. In fact, there are much more important usages of Git, like `branch`, `merge`, `conflict`, and `pull request`. Go to [GitKraken Guide](https://support.gitkraken.com/start-here/guide/) for more.
...
* Push it to GitHub as a `remote` repository. This is the place you turn in your assignments.

* Go to GitHub, click `ESE5023_Assignment` repository, then `Settings`. Under the `Manage access` sub-page, click `Invite a collaborator`, add invite `MingYang-Hydrate` and `topleo` as collaboratos. By doing so, your TAs will be able to get access to your GitHub `ESE5023_Assignment` repository, and they will grade your assignments and provide necessary feedback. 
