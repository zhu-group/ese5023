---
title: "Section 10 Spatial Data Types in R"
output:
  html_document:
    toc: true
    toc_float:
...
* Data source name (`dsn`), this is the path to the folder that contains the files.

* Layer name (`layer`), this is the shape file name WITHOUT extension.
...
Count how many provinces have areas of between `0.1 million` and `0.2 million` km^2^ according to the `China_map` object. Plot those provinces in red.
