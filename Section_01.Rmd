...
* At the end of the semester, you should be able to:
  ...
  + Proceed statistical sleuth with Python
...
This course is designed for ESE graduate students having ***no or weak*** programming background, with emphasis on Python, FORTRAN, Git, and Linux.
...
* I have a strong programming background with Python and other tools (C, C++, Java, MATLAB, R, IDL, etc.)
...
* I don’t have (any) coding/programming experience
