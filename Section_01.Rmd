...
**8. Do you use the following AI tools for coding? **  
...
**9. In your view, why is programming necessary?** (open question) 
...
**10. In your view, why is programming hard?** (open question, [source](https://makemeaprogrammer.com/is-programming-hard/))
...
**11. Name one thing you want to achieve at the end of the semester** (open question)  
...
* Three languages: Python, Shell (BASH), and FORTRAN (Supplement)  
* One operation system: Linux  
* At the end of the semester, you should be able to:
  + Use Git for version control
    - Github, GitKraken, etc.  
  + Set up and manage Python environments
    - Conda, dependency isolation
  + Handle common file formats with Python
    - plain text, .csv, .nc, .hdf, etc.
  + Work with data neatly using core packages like `numpy` and `pandas`
  + Create publication-quality figures and maps
    - `matplotlib` and `cartopy`
  + Harness AI for scientific coding
    - LLM foundations, context engineering, automated code verification, and agentic workflows
  ...
  + [Supplement] Process multi-dimensional data and scientific statistics
    - `xarray` and `SciPy`
    - comparing means, ANOVA, regressions, etc.  
  + [Supplement] Conduct parallel computing in Python
  + [Supplement] Write, compile, and run FORTRAN scripts
