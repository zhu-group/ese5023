...
<img src="figs/xarray-split-apply-combine.png" alt="drawing" width="800"/>  
...
# More than one conditions
sample.where((sample.lat < 5) & (sample.lat > -5) & (sample.lon > 190) & (sample.lon < 240)).plot(size=6, robust=True)
```
