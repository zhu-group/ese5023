...
**Structure:**   
The course will meet on Thursday weekly, and on Tuesday every other week (odd week only). On Thursday, new material will be presented by the instructor followed by in-class exercises. On Tuesday, the class will trun into a lab - class time will be devoted to working on in-class exercises and assignments, discussing the final project, and one-on-one interactions between students and the instructor/TA.
...
**Laptop:**   
Students are **required** to have a laptop available to bring to class to learn the material, participate in-class exercises, and work on the assignments. Students are encouraged to check [resources](https://zhu-group.github.io/ese5023/Resource.html) for softwares/tools used in the course.
