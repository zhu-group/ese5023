...
Check [`cartopy` projection list](https://cartopy.readthedocs.io/stable/reference/projections.html) for a list of available projections supported by `cartopy`.
...
For higher-resolution features, `cartopy` can automatically download and create them from the [Natural Earth Data](https://www.naturalearthdata.com/) or the [Global Self-consistent, Hierarchical, High-resolution Geography Database](https://www.soest.hawaii.edu/pwessel/gshhg/) database.
...
+ [`Cartopy` gallery](https://cartopy.readthedocs.io/stable/gallery/index.html)
