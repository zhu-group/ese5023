...
+ To convert a notebook file (e.g., `xxx.ipynb`) to a `python` file (e.g., `xxx.py`), open `Anaconda Powershell Prompt (anaconda3)`, change to the path contains the notebook file, type: `ipython nbconvert --to script xxx.ipynb`
