...
**[Bonus] [10 points]** Following equation 5-13, compute the atmospheric CO~2~ level in ppm and reproduce Figure 4 in Tomizuka (2009). 

Useful data sets:  

* [Global Fossil-Fuel CO~2~ Emissions](https://cdiac.ess-dive.lbl.gov/trends/emis/tre_glob.html)
* [Mauna Loa CO~2~ annual mean data](https://gml.noaa.gov/ccgg/trends/data.html)
* [Historical CO2 Records from the Law Dome DE08, DE08-2, and DSS Ice Cores](https://cdiac.ess-dive.lbl.gov/trends/co2/lawdome.html)
