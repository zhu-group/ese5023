...
**[25 points]** Use research data from your group, make `5` types of plot with the `ggplot2` package:
...
In this exercise, we will take another look at the [hourly weather data](https://zhu-group.github.io/ese5023/Section_03.html#Exercise_2) measured at the BaoAn International Airport during the past 10 years. 

**2.1 [5 points]** Construct a time series of monthly-averaged temperature from 2010 Jan. to 2020 Aug.

**2.2 [5 points]** Decompose the time series into trend, seasonality, and error parts. Verify the error part follows a white noise distribution.

**2.3 [10 points]** Fit an ARIMA model to the time series. Provide a detailed fitting process in your report.

**2.4 [5 points]** Make predictions of monthly temperatures in 2020 Sep. and Oct. using the ARIMA model from 2.3. The predictions will be evaluated against real observations in those two months.
