...
**2.1 [5 points]** Make a global map of a certain variable. Your figure should contain: a project, x labels, y labels, title, gridlines, legend, colorbar, masks, annotations, and text box (**0.5 points each**).

**2.2 [5 points]** Make a regional map of the same variable. Your figure should contain: a different project, x labels, y labels, title, gridlines, legend, colorbar, masks, annotations, and text box (**0.5 points each**).
