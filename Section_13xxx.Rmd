---
title: "Section 13 Web scraping with `Python`"
output:
  html_document:
    toc: true
    toc_float:
...
```{python, eval=F}
# URL
data_url = 'https://www.wunderground.com/history/daily/cn/shenzhen/ZGSZ/date/2021-12-5'
...
Now let's modify the above chunk of code to save data to a local file (`Shenzhen_20221205.csv`).
...
end_date = datetime(year=2022, month=1, day=3)
