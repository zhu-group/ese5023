...
**1.8** We can transfer a log-normal distribution to a normal distribution using logarithmic calculations. Now take `log` on `mean_gdpPercap`, and assign the results to a new vector `mean_gdpPercap_log`. Check the distribution of `mean_gdpPercap_log`.
