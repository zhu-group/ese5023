...
Browse the [CASEarth website](http://data.casearth.cn/). Search and download a data set you are interested in. Your data should be in `csv` or `XLSX` format. In R, do the following:  
**7.1 [5 points]** Load the `csv` or `XLSX` file.  
