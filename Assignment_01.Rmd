...
Browse the [CASEarth website](http://data.casearth.cn/). Search and download a data set you are interested in. Your data should be in `csv` or `XLSX` format, and have temporal information. In R, do the following:  
