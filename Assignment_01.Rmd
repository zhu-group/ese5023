...
**[20 points]** If you start with 1 RMB and, with each move, you can either double your money or add another 1 RMB, what is the smallest number of moves you have to make to get to exactly *x* RMB? Here *x* is randomly selected from `100` to `200`. Write a function `Smallest_number` to print your results. For example, `Smallest_number(2)` should print `2`, and `Smallest_number(5)` should print `3`.
