...
**[15 points]** One of the most interesting number patterns is [Pascal's triangle](https://www.mathsisfun.com/pascals-triangle.html) (named after Blaise Pascal). Write a function `Pascal_triangle` with an argument `N` to print the *N*th line of the Pascal triangle. Report `Pascal_triangle(100)` and `Pascal_triangle(200)`.
