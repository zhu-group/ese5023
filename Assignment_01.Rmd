...
**6.2 [10 points]** For each year, report the number of days with visibility within the respective interval: `[0,5km)`,`[5km,10km)`,`[10km,15km)`,`[15km,20km)`,`[20km,25km)`,`[25km,30km)`, and `>=30km`. Is the visibility getting better or worse?

***

# 7. Explore a data set

Browse the [CASEarth website](http://data.casearth.cn/), [NOAA Land-Based Datasets and Products ](https://www.ncdc.noaa.gov/data-access/land-based-station-data/land-based-datasets), or [Advanced Global Atmospheric Gases Experiment (AGAGE)](https://agage.mit.edu/). Search and download a data set you are interested in. Your data set should be in `csv`, `XLS`, or `XLSX` format, and have temporal information. In R, do the following:  
