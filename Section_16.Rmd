...
Browse [`Seaborn` gallery](https://altair-viz.github.io/gallery/index.html).
...
Browse [`Seaborn` gallery](https://scitools.org.uk/cartopy/docs/latest/gallery/index.html).
...
* [Python for Earth Scientists](https://homepages.see.leeds.ac.uk/~earawa/PythonEarthSci/)
