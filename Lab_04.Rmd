...
**1.** Download the [sst.mnmean.nc](https://psl.noaa.gov/thredds/fileServer/Datasets/noaa.ersst.v5/sst.mnmean.nc) (~ `80 MB`). Read it with `pandas` as the data object `ds`. 
