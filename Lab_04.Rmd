...
**12.** Make a timeseries of the anomalies within the lat range (`20S`-`20N`) and lon range (`170`E to `170 W`), show resample means and rolling means at the desired frequencies. Use the tips we covered in the [last Section](https://zhu-group.github.io/ese5023/Section_08.html), modify the plot as much as you can.
