...
**[10 points]** Plot monthly averaged air temperature as a function of the observation time. Is there a trend in monthly averaged air temperature in the past `25` years? 
...
**3.1 [5 points]** Group the data on Storm Identifie (`SID`), report names (`NAME`) of the `10` largest hurricanes according to wind speed (a.k.a., `WMO_WIND`).
...
**3.8 [5 points]** Calculate the climatology of datapoint counts as a function of `day of year`. [The day of year (DOY)](https://nsidc.org/data/user-resources/help-center/day-year-doy-calendar) is the sequential day number starting with day 1 on January 1st.  
