...
**1.3 [10 points]** Compute the total number of earthquakes with magnitude larger than `6.0` (use column `EQ_PRIMARY` as the magnitude) worldwide each year, and then plot the time series. Do you observe any trend? Explain why or why not? 
